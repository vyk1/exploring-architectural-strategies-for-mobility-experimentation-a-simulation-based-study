 ...
 */
public class IPA_RandomMobility_Microservices_Clustered_4Modules {
    ...
    private static Application createApplication(String appId, int userId) {
        ...
        application.addAppModule("preprocessingM", 512*2, 250*2, 200*2);
        application.addAppModule("processingM", 512*2, 350 + 250, 200*2);
...
//        processing = tr + po
        ...
        application.addAppEdge("clientModule", "preprocessingM", 2000, 500, 14*3, "RAW_DATA", Tuple.UP, AppEdge.MODULE);
        application.addAppEdge("preprocessingM", "processingM", 2500, 500, "FILTERED_DATA1", Tuple.UP, AppEdge.MODULE);
        application.addAppEdge("processingM", "database", 1000, 1000, "FILTERED_DATA2", Tuple.UP, AppEdge.MODULE);

        application.addAppEdge("processingM", "clientModule", 14, 500, "RESULT1", Tuple.DOWN, AppEdge.MODULE);
        ...
        application.addTupleMapping("preprocessingM", "RAW_DATA", "FILTERED_DATA1", new FractionalSelectivity(1.0));
        application.addTupleMapping("processingM", "FILTERED_DATA1", "RESULT1", new FractionalSelectivity(1.0));
    	...
    	if (CLOUD) {
            application.setSpecialPlacementInfo("preprocessingM", "cloud");
            application.setSpecialPlacementInfo("processingM", "cloud");
		}
